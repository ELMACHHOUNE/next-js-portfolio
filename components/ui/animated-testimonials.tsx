...
function seededInRange(seed: string, min: number, max: number) {
          ...
          <div className="relative w-full" style={{ aspectRatio: "3 / 4" }}>
            <AnimatePresence>
              {testimonials.map((testimonial, index) => {
                const baseSeed = `${testimonial.src ?? ""}-${index}`;
                const rotationA = seededInRange(`${baseSeed}-a`, -8, 3);
                const rotationB = seededInRange(`${baseSeed}-b`, -8, 3);
                ...
                return (
                  <motion.div
                    ...
                    animate={{
                      ...
                      rotate: isActive(index) ? 0 : rotationB,
